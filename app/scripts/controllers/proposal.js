...
angular.module('projetobrasilFrontApp').controller('ProposalCtrl', ['$scope', '$state', '$location', '$stateParams', 'proposalsGetter', 'categoryColorGetter', function ($scope, $state, $location, $stateParams, proposalsGetter, categoryColorGetter) {
